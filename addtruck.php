...
if(isset($_GET['result'])) {
	echo "<h2 class='alter alert-danger text-center' color:white'>". $_GET['result'] ."</h2>";
}

?>
					<div class="my-3"><h4>ADD TRUCK</h4></div>
					<form action="addaction.php" method="post" style="margin-left:5px; padding:5px;" enctype="multipart/form-data">
						<p id='chose'></p>

          			  <input type="text" name="tid" class="d-none" value="<?php echo $owner_id; ?>">
                    ...
                    <div class="mt-2">	
            	<button class="btn btn-sm btn-primary" type="submit" name="add_truck" id="btn">Post</button>
					</div>
					</form>
				</div>
				</div>

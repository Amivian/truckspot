                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h2 class="main-title">Edit Plan</h2>
                            <div class="card">
                                <div class="card-heading">Plans</div>
                                <!--   edit details -->
                                <div class="card-body">
                             <form method="POST" class="form-horizontal" action="edite.php">
                                <div class="">
                                <input type="hidden" name="edit_id" value="<?php echo $id ?>">
                                <label for="">Edit Plan:</label>
                                <input type="text" name="plan" class="">
                                <button type="submit" class="btn btn-sm btn-danger mt-2" name="plan_btn">update</button>
                            </div>
				            </form>
                        </div>
                        </div>

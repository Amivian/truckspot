                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h2 class="main-title">Add Plan</h2>
                            <div class="card">
                                <div class="card-heading">Add Plan</div>
                                <div class="card-body">
...
?>								<form action="addp.php" method="post">
								...
								<div>
								<label for="">Add Plan:</label>
								<input type="text" name="plan">
								<button type="submit" class="btn btn-sm btn-danger" name="plan_btn">Add</button>
							</div>
</form>

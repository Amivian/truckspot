                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h2 class="main-title">Edit Truck Category</h2>
                            <div class="card">
                                <div class="card-heading">Category Details</div>
                                <!--   edit details -->
                                <div class="card-body">
                             <form method="POST" class="form-horizontal" action="editt.php">
                                <div class="">
                                <input type="hidden" name="edit_id" value="<?php echo $id ?>">
                                <label for="">Edit Category:</label>
                                <input type="text" name="cat" class="">
                                <button type="submit" class="btn btn-sm btn-danger mt-2" name="cat_btn">update</button>
                            </div>
				            </form>
                        </div>
                        </div>
